...
class TestSymbolMarkets:
    ...
    def test_build_payload_with_custom_columns(self, symbol_markets):
        ...
        payload = symbol_markets._build_payload(symbol="BTCUSD", columns=custom_columns)
    ...
    def test_build_payload_with_limit(self, symbol_markets):
        ...
        payload = symbol_markets._build_payload(symbol="TSLA", limit=50)
    ...
    def test_scrape_success(self, mock_post, symbol_markets):
        ...
        mock_response.json.return_value = {
            "data": [
                {"s": "NASDAQ:AAPL", "d": ["AAPL", 150.25, 2.5, 3.75, 50000000, "NASDAQ", "stock", "Apple Inc.", "USD", 2500000000000]},
                {"s": "GPW:AAPL", "d": ["AAPL", 148.50, 1.2, 1.80, 1000000, "GPW", "stock", "Apple Inc.", "PLN", 2500000000000]},
            ],
            "totalCount": 2,
        }
    ...
    def test_scrape_with_custom_columns(self, symbol_markets):
        ...
        time.sleep(3)
        custom_columns = ["name", "close", "volume", "exchange"]
        result = symbol_markets.scrape(symbol="AAPL", columns=custom_columns, scanner="america", limit=10)
