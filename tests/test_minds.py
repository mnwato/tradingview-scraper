...
class TestMinds:
    ...
    def test_get_minds_success(self, mock_get, minds):
        ...
        mock_response.json.return_value = {
            "results": [
                {
                    ...
                    "author": {"username": "testuser", "uri": "/u/testuser/", "is_broker": False},
            ...
            "meta": {"symbol": "NASDAQ:AAPL", "symbols_info": {"NASDAQ:AAPL": {"short_name": "AAPL", "exchange": "NASDAQ"}}},
        }
    ...
    def test_get_minds_no_data(self, mock_get, minds):
        ...
        mock_response = mock.Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {"results": [], "meta": {}}
        mock_get.return_value = mock_response
    ...
    def test_get_minds_real_aapl_recent(self, minds):
        ...
        time.sleep(3)
        result = minds.get_minds(symbol="NASDAQ:AAPL", sort="recent", limit=10)
    ...
    def test_get_minds_real_aapl_popular(self, minds):
        ...
        time.sleep(3)
        result = minds.get_minds(symbol="NASDAQ:AAPL", sort="popular", limit=10)
    ...
    def test_get_minds_real_btcusd(self, minds):
        ...
        time.sleep(3)
        result = minds.get_minds(symbol="BITSTAMP:BTCUSD", sort="recent", limit=10)
    ...
    def test_get_minds_with_symbol_info(self, minds):
        ...
        time.sleep(3)
        result = minds.get_minds(symbol="NASDAQ:AAPL", sort="recent", limit=5)
