...
class TestFundamentalGraphs:
    ...
    def test_get_fundamentals_success(self, mock_get, fundamentals):
        ...
        mock_response.json.return_value = {"total_revenue": 394000000000, "net_income": 100000000000, "EBITDA": 130000000000, "market_cap_basic": 2800000000000, "price_earnings_ttm": 28.5}
    ...
    def test_get_fundamentals_with_custom_fields(self, fundamentals):
        ...
        result = fundamentals.get_fundamentals(symbol="NASDAQ:AAPL", fields=custom_fields)
    ...
    def test_compare_fundamentals(self, mock_get, fundamentals):
        ...
        mock_response = mock.Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {"total_revenue": 400000000000, "net_income": 100000000000, "market_cap_basic": 2800000000000}
        mock_get.return_value = mock_response

        time.sleep(3)
        result = fundamentals.compare_fundamentals(symbols=["NASDAQ:AAPL", "NASDAQ:MSFT"], fields=["total_revenue", "net_income", "market_cap_basic"])
    ...
    def test_compare_fundamentals_real(self, fundamentals):
        ...
        time.sleep(3)
        result = fundamentals.compare_fundamentals(symbols=["NASDAQ:AAPL", "NASDAQ:MSFT"], fields=["total_revenue", "net_income"])
