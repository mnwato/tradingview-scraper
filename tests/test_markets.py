...
class TestMarkets:
    ...
    def test_get_top_stocks_success(self, mock_post, markets):
        ...
        mock_response.json.return_value = {
            "data": [
                {"s": "NASDAQ:AAPL", "d": ["AAPL", 150.25, 2.5, 3.75, 50000000, 0.8, 2500000000000, 25.5, 6.0, "Technology", "Consumer Electronics"]},
                {"s": "NASDAQ:MSFT", "d": ["MSFT", 380.00, 1.8, 6.80, 30000000, 0.7, 2800000000000, 30.0, 12.5, "Technology", "Software"]},
            ],
            "totalCount": 2,
        }
    ...
    def test_get_top_stocks_real_america_by_volume(self, markets):
        ...
        time.sleep(3)
        result = markets.get_top_stocks(market="america", by="volume", limit=10)
    ...
    def test_get_top_stocks_real_crypto(self, markets):
        ...
        result = markets.get_top_stocks(market="crypto", by="volume", limit=10)
    ...
    def test_get_top_stocks_with_custom_columns(self, markets):
        ...
        result = markets.get_top_stocks(market="america", by="market_cap", columns=custom_columns, limit=5)
