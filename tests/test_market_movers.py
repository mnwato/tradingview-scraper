...
class TestMarketMovers:
    ...
    def test_build_scanner_payload(self, market_movers_scraper):
        ...
        payload = market_movers_scraper._build_scanner_payload(market="stocks-usa", category="gainers", limit=10)
    ...
    def test_scrape_success(self, mock_post, market_movers_scraper):
        ...
        mock_response.json.return_value = {
            "data": [
                {"s": "NASDAQ:AAPL", "d": ["Apple Inc.", 150.25, 2.5, 3.75, 50000000, 2500000000000, 25.5, 6.0, "logo-id", "Tech company"]},
                {"s": "NASDAQ:GOOGL", "d": ["Alphabet Inc.", 2800.00, 1.8, 50.00, 30000000, 1800000000000, 28.0, 100.0, "logo-id-2", "Tech company"]},
            ]
        }
    ...
    def test_scrape_real_gainers(self, market_movers_scraper):
        ...
        time.sleep(3)
        result = market_movers_scraper.scrape(market="stocks-usa", category="gainers", limit=5)
    ...
    def test_scrape_real_losers(self, market_movers_scraper):
        ...
        time.sleep(3)
        result = market_movers_scraper.scrape(market="stocks-usa", category="losers", limit=5)
    ...
    def test_scrape_real_penny_stocks(self, market_movers_scraper):
        ...
        time.sleep(3)
        result = market_movers_scraper.scrape(market="stocks-usa", category="penny-stocks", limit=5)
    ...
    def test_scrape_with_custom_fields(self, market_movers_scraper):
        ...
        result = market_movers_scraper.scrape(market="stocks-usa", category="gainers", fields=custom_fields, limit=5)
