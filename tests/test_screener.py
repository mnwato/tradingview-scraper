...
class TestScreener:
    ...
    def test_screen_success(self, mock_post, screener):
        ...
        mock_response.json.return_value = {
            "data": [
                {"s": "NASDAQ:AAPL", "d": ["Apple Inc.", 150.25, 2.5, 3.75, 50000000, 0.8, 2500000000000, 25.5, 6.0]},
                {"s": "NASDAQ:GOOGL", "d": ["Alphabet Inc.", 2800.00, 1.8, 50.00, 30000000, 0.7, 1800000000000, 28.0, 100.0]},
            ],
            "totalCount": 2,
        }
    ...
    def test_screen_with_filters(self, mock_post, screener):
        ...
        mock_response = mock.Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {"data": [{"s": "NASDAQ:AAPL", "d": ["Apple Inc.", 150.25, 2.5, 3.75, 50000000]}], "totalCount": 1}
        mock_post.return_value = mock_response
    ...
    def test_screen_real_america(self, screener):
        ...
        time.sleep(3)
        filters = [{"left": "close", "operation": "greater", "right": 10}, {"left": "volume", "operation": "greater", "right": 100000}]
        result = screener.screen(market="america", filters=filters, sort_by="volume", sort_order="desc", limit=5)
    ...
    def test_screen_real_crypto(self, screener):
        ...
        time.sleep(3)
        result = screener.screen(market="crypto", sort_by="volume", limit=5)
    ...
    def test_screen_real_forex(self, screener):
        ...
        time.sleep(3)
        result = screener.screen(market="forex", limit=5)
    ...
    def test_screen_with_custom_columns(self, screener):
        ...
        time.sleep(3)
        custom_columns = ["name", "close", "volume"]
        result = screener.screen(market="america", columns=custom_columns, limit=3)
    ...
    def test_screen_with_range_filter(self, screener):
        ...
        result = screener.screen(market="america", filters=filters, limit=5)
